...
#define CFLAGS      "-std=c99 -W -Wall -O2  -mpopcnt -mavx -mavx2 -mpclmul"
#define CXXFLAGS    "-std=c++11 -O2  -mpopcnt -mavx -mavx2 -mpclmul"
#define    ULONG_BITS   64
#define    ULONGLONG_BITS   64

#define    HAVE_CXX11

#define GMP_INCDIR    "/opt/anaconda3/include"
#define GMP_LIBDIR    "/opt/anaconda3/lib"
#define MPIR_INCDIR    ""
#define MPIR_LIBDIR    ""
/* #undef HAVE_MPIR */
...
/* #undef HAVE_GAS_SYNTAX_ASSEMBLY_SOURCES */
...
/* #undef HAVE_STDCPP_MATH_SPEC_FUNCS */
...
/* #undef HAVE_GLIBC_VECTOR_INTERNALS */
#define    HAVE_INT128

#define    HAVE_ALIGNED_ALLOC

/* #undef UINT64_T_IS_EXACTLY_UNSIGNED_LONG */
#define    UINT64_T_IS_EXACTLY_UNSIGNED_LONG_LONG
/* #undef INT64_T_IS_EXACTLY_LONG */
#define    INT64_T_IS_EXACTLY_LONG_LONG
...
#define    UINT64_T_IS_COMPATIBLE_WITH_UNSIGNED_LONG
/* #undef UINT64_T_IS_COMPATIBLE_WITH_UNSIGNED_LONG_LONG */
#define    INT64_T_IS_COMPATIBLE_WITH_LONG
/* #undef INT64_T_IS_COMPATIBLE_WITH_LONG_LONG */
